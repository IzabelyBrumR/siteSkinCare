            ...
            if(isset($pedidos)){
                foreach($pedidos as $pedido){
                    echo "<tr>";
                        ...
                        echo "<td>";
                        echo '<a href="./controller/confirmarPedidoController.php?id='.$pedido['id'].'"><button class="btn btn-success">Confirmar</button></a>';
                        echo "</td>";
                        echo "<td>";
                        echo '<a href="./controller/recusarPedidoController.php?id='.$pedido['id'].'"><button class="btn btn-danger">Recusar</button></a>';
                        echo "</td>";
                    echo '</div>';
                }
            }
